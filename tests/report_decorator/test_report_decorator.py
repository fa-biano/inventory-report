...
def test_decorar_relatorio():
    report = ColoredReport(SimpleReport).generate(DICT)

    label1 = 'Data de fabricação mais antiga:'
    label2 = 'Data de validade mais próxima:'
    label3 = 'Empresa com mais produtos:'

    text_builder = [
        f'{GREEN}{label1}{RESET} {BLUE}2020-09-06{RESET}\n',
        f'{GREEN}{label2}{RESET} {BLUE}2023-09-17{RESET}\n',
        f'{GREEN}{label3}{RESET} {RED}Target Corporation{RESET}',
    ]
